...
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, joinRelativeURL } from 'file://D:/Projects/crimea/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file://D:/Projects/crimea/node_modules/vue/server-renderer/index.mjs';
import { hash } from 'file://D:/Projects/crimea/node_modules/ohash/dist/index.mjs';
import { propsToString, renderSSRHead } from 'file://D:/Projects/crimea/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file://D:/Projects/crimea/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file://D:/Projects/crimea/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file://D:/Projects/crimea/node_modules/hookable/dist/index.mjs';
import { klona } from 'file://D:/Projects/crimea/node_modules/klona/dist/index.mjs';
import { snakeCase } from 'file://D:/Projects/crimea/node_modules/scule/dist/index.mjs';
import defu, { defuFn } from 'file://D:/Projects/crimea/node_modules/defu/dist/defu.mjs';
import { createStorage, prefixStorage } from 'file://D:/Projects/crimea/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://D:/Projects/crimea/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file://D:/Projects/crimea/node_modules/radix3/dist/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { consola } from 'file://D:/Projects/crimea/node_modules/consola/dist/index.mjs';
import { getContext } from 'file://D:/Projects/crimea/node_modules/unctx/dist/index.mjs';
import { isVNode, version, unref } from 'file://D:/Projects/crimea/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1, CapoPlugin } from 'file://D:/Projects/crimea/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file://D:/Projects/crimea/node_modules/@unhead/shared/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"D:/Projects/crimea/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"D:\\Projects\\crimea","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"D:\\Projects\\crimea\\server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"D:\\Projects\\crimea\\.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"D:\\Projects\\crimea\\.nuxt\\cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"D:\\Projects\\crimea\\.data\\kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _QvNacVxciH = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "D:/Projects/crimea";
...
const _lazy_fdoLv6 = () => Promise.resolve().then(function () { return yookassa$1; });
const _lazy_wIvv3l = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/api/yookassa', handler: _lazy_fdoLv6, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_wIvv3l, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_wIvv3l, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('file://D:/Projects/crimea/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file://D:/Projects/crimea/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
