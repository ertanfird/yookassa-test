...
import { $ as $fetch, w as withQuery, m as hasProtocol, n as isScriptProtocol, o as joinURL, p as sanitizeStatusCode, q as createHooks, i as createError$1, t as isEqual, v as toRouteMatcher, x as createRouter, y as defu, z as stringifyParsedURL, A as stringifyQuery, B as parseQuery } from '../runtime.mjs';
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-BLe0C2JT.mjs').then((r) => r.default || r));
...
export { _export_sfc as _, navigateTo as a, useRuntimeConfig as b, useHead as c, entry$1 as default, nuxtLinkDefaults as n, useRouter as u };
